module.exports = {
  ...
  'cursors': 'manage cursors',
  'cursors:create': require('./cursors/create'),
  'cursors:delete': require('./cursors/delete'),
  'cursors:display': require('./cursors/display'),
  'cursors:list': require('./cursors/list'),
  'cursors:read': require('./cursors/read'),
  'cursors:advance': require('./cursors/advance'),
  'cursors:rewind': require('./cursors/rewind'),
